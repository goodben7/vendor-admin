...
import { useAboutMe, useUpdateMe } from '@/hooks/useUsers';
        ...
        <Card className="border-none shadow-xl shadow-black/5 rounded-[2rem] overflow-hidden bg-card/50 backdrop-blur-md">
            <CardHeader className="p-8 pb-4">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <CardTitle className="text-2xl font-black tracking-tight">Informations personnelles</CardTitle>
                        <CardDescription className="font-bold text-muted-foreground/60">Mettez à jour vos informations de profil</CardDescription>
                    </div>
                </div>
            </CardHeader>
